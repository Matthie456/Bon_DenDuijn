...
<qgis version="2.12.0-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="Hidden" name="stopname">
    ...
    <edittype widgetv2type="Classification" name="network">
  ...
  <renderer-v2 attr="network" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="false" symbol="1" value="ferry" label="ferry"/>
      <category render="false" symbol="2" value="metro" label="metro"/>
      <category render="false" symbol="3" value="rail" label="rail"/>
      <category render="false" symbol="4" value="tram" label="tram"/>
